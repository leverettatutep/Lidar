...
z     = peaks2(n);             % sample function defined on a grid of the same dimenision
...
tic;
[intersect, AllDist, AllU, AllV, AllCoor] = TriangleRayIntersection(orig, dir, vert1, vert2, vert3);
numberHits = sum(intersect)
baryCenterCoord = zeros(numberHits,2);
xyzOfHits = zeros(numberHits,3);
distToHits = zeros(numberHits);
hit = 1;
